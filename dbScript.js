    ...
    cReq.addEventListener("success",function(){
        ...
        if(cursor){
            ...
            <button class="delete" data-id="${mo.mId}">Delete</button>`;
              ...
              <button class="download">DOWNLOAD<i class="fa fa-download" style="font-size:12px;color:black;margin-left:2rem";></i> </button>
              <button class="delete" data-id="${mo.mId}">DELETE<i class="fa fa-trash-o" style="font-size:12px;color:black;margin-left:2rem;"></i></button>`;
